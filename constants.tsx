...
export const INSTALLED_APPS: AppConfig[] = [
  ...
  { id: AppID.GroupChat, name: '群聊', icon: 'GroupChat', color: 'violet' }, // New
...
export const DOCK_APPS = [AppID.Chat, AppID.GroupChat, AppID.Date, AppID.Room]; // Added GroupChat to dock
